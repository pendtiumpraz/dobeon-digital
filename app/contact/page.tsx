  ...
  return (
    <>
      <Hero
        ...
        description="Ready to turn your ideas into reality? Contact us to discuss your project requirements and get a free consultation."
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              We&apos;re here to answer your questions and discuss how we can help build your next web app, mobile app, or enterprise system.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="enterprise">Enterprise System (ERP/CRM/HRM)</option>
      ...
      <Section className="text-center bg-gray-50">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
          Why Choose Dobeon Digital?
        </h2>
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          We combine technical excellence with deep industry knowledge to deliver solutions that truly work for your business.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-primary transition-all duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Modern Stack</h3>
            <p className="text-gray-600">Latest frameworks & technologies</p>
          </div>
          <div className="p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-primary transition-all duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">All Industries</h3>
            <p className="text-gray-600">Experience across 25+ sectors</p>
          </div>
          <div className="p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-primary transition-all duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">End-to-End</h3>
            <p className="text-gray-600">From design to deployment</p>
          </div>
        </div>
      </Section>
    </>
