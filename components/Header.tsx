    ...
    >
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[9999] md:hidden">
          ...
          {/* Menu Panel */}
          <div
            className="absolute top-0 right-0 bottom-0 w-80 max-w-[85vw] shadow-2xl flex flex-col"
            ...
            >
              {navLinks.map((link) => (
                <Link
                  ...
                  href={link.href}
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-4 px-4 py-4 rounded-xl text-gray-800 hover:text-primary hover:bg-blue-50 font-medium text-lg mb-2"
            ...
            >
              <div className="flex justify-center gap-4">
                <a
                  ...
                  className="w-11 h-11 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-primary hover:bg-primary hover:text-white hover:border-primary"
                  aria-label="LinkedIn"
                >
