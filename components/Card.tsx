...
export default function Card({
  ...
  const getGradientClass = () => {
    ...
    if (gradient === true) {
      return 'bg-gradient-to-br from-indigo-600 to-primary text-white shadow-xl shadow-indigo-500/20';
    }
      ...
      {isGradient && (
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute inset-0" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.3'%3E%3Cpath d='M20 20h20v20H20zM0 0h20v20H0z'/%3E%3C/g%3E%3C/svg%3E")`,
          }}></div>
        </div>
      )}
