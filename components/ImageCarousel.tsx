...
export default function ImageCarousel({
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Cross-platform mobile apps with Flutter and React Native for iOS and Android',
      tag: 'Mobile'
    },
    {
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=80',
      title: 'Enterprise Systems',
      description: 'Custom ERP, CRM, and business management solutions tailored to your needs',
      tag: 'Enterprise'
    },
    {
      image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1600&q=80',
      title: 'AI-Powered Solutions',
      description: 'Intelligent applications with Machine Learning, NLP, and Generative AI',
        ...
        <div className="relative h-[450px] md:h-[550px] lg:h-[600px]">
          {slides.map((slide, index) => (
            ...
            >
              ...
              {/* Overlay gradient - tech themed */}
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-900/90 via-black/50 to-transparent" />
              <div className="absolute inset-0 bg-gradient-to-r from-primary/40 to-transparent" />

              {/* Content */}
              <div className="absolute inset-0 flex items-end">
                <div className="p-8 md:p-12 lg:p-16 w-full max-w-3xl">
                  <span className="inline-block px-4 py-1.5 bg-gradient-to-r from-primary to-cyan-500 backdrop-blur-sm text-white text-sm font-semibold rounded-full mb-4 shadow-lg">
                    {slide.tag}
                  </span>
