...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      ...
      { label: 'Enterprise Systems', href: '/services#enterprise' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Let us help you create powerful digital solutions for your business.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-8 max-w-sm leading-relaxed">
              Building powerful web applications, mobile apps, enterprise systems, and AI-powered solutions for businesses across all industries.
            </p>
